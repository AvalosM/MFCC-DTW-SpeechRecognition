...
; fcomplex cmul_pair(fcomplex[2]x(xmm0), fcomplex[2]y(xmm1))
...
; fcomplex fcdot_asm(fcomplex *x(rdi), fcomplex *y(rsi), unsigned int length(rdx))
fcdot_asm:
    ; ----------------
    ; ------Body------
    ; ----------------
    ...
    call cmul_pair          ; xmm0 = | x[i + 1] * y[i + 1] | x[i] * y[i]         |
